...
def build_model(model_name):
    ...
    if model_name == "hierarchical_focus_attention":
        return HierarchicalFocusAttentionModel(pretrained=True, coarse=cfg.COARSE_CLASSES, pronuclear=cfg.PRONUCLEAR_CLASSES,cleavage=cfg.CLEAVAGE_CLASSES, blastocyst=cfg.BLASTOCYST_CLASSES, num_layers=cfg.NUM_LAYERS, dropout=cfg.DROPOUT)
